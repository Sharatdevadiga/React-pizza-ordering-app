      ...
      <Form method="POST">
        ...
        <div className="relative flex flex-col gap-2 mb-5 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            />
            {addressStatus === "error" && (
              <p className="mt-2 text-xs text-red-700 bg-red-100 rounded-md top-[3px]">
                {errorAddress}
              </p>
            )}
          </div>
          {!position.latitude && !position.longitude && (
            <span className="absolute  right-[3px] sm:right-[3px] top-[0px] md:top-[5px] z-50">
              <Button
                type="small"
                disabled={isLoadingAddress}
                onClick={(e) => {
        ...
        <div>
          {/* connecting the cart to the form */}
